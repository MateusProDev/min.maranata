...
exports.UploadButton = exports.InsertButton = exports.DownloadButton = exports.DeleteButton = exports.CopyToClipBoardButton = void 0;
...
class CopyToClipBoardButton extends _react.default.Component {
  constructor(...args) {
    ...
    _defineProperty(this, "handleCopy", () => {
      ...
      (0, _copyTextToClipboard.default)((0, _decapCmsLibUtil.isAbsolutePath)(path) || !draft ? path : name);
      this.setState({
        copied: true
      });
    ...
    _defineProperty(this, "getTitle", () => {
      ...
      if ((0, _decapCmsLibUtil.isAbsolutePath)(path)) {
  ...
  render() {
    ...
    return (0, _react2.jsx)(ActionButton, {
      disabled: disabled,
